...
# This script allows users to input student names and randomly assigns them to three teams.
# Prompts written by Shay Crane and code generated by OpenAI's GPT-3.5.
